...
from depend.beaker.container import NamespaceManager, Container
from depend.beaker.crypto.util import sha1
from depend.beaker.exceptions import InvalidCacheBackendError, MissingCacheParameter
from depend.beaker.synchronization import file_synchronizer
from depend.beaker.util import verify_directory, SyncDict, parse_memcached_behaviors
import warnings

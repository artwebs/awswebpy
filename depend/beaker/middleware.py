...
try:
    from depend.paste.registry import StackedObjectProxy
...
from depend.beaker.cache import CacheManager
from depend.beaker.session import Session, SessionObject
from depend.beaker.util import coerce_cache_params, coerce_session_params, \
